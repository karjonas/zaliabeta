/// @description  ContinueSaveScreen_Room_End()
function ContinueSaveScreen_Room_End() {
	...
	*/
	...
	if (_exists)                                 Caution_dl_text = undefined;
	    ...
	    _exists = variable_instance_exists(id,  "dg_Options");
	if (_exists) _exists =      !is_undefined(   dg_Options);
	if (_exists) _exists =       ds_exists(      dg_Options, ds_type_grid);
	if (_exists)                 ds_grid_destroy(dg_Options);
	if (_exists)                                 dg_Options = undefined;
