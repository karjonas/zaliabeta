/// @description  init_vars_go_4a()
function init_vars_go_4a() {
	...
	scr_draw     = undefined; // draw
	scr_room_end = undefined; // Room End Event
	scr_destroy  = undefined; // Destroy Event
	scr_inst_end = undefined; // Instance End. Ran in Room End Event & Destroy Event
