/// @description  tile_change_3a(size 8 or 16, ts,tsrc, x,y, depth, 1:add -1:delete 0:both)
function tile_change_3a(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
